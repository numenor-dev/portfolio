...
export default function Contact() {
  return (
    <section>
      <h1 className="max-w-5xl text-center mb-3 md:mb-2 md:text-left mx-auto text-6xl md:text-7xl font-bold py-20">
        Contact
      </h1>
          ...
          <div className="md:ml-4">
            ...
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md 
                ...
                hover:dark:border hover:dark:border-blue-500 p-4"
              >
                <svg
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md 
                ...
                hover:dark:border hover:dark:border-blue-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
