  ...
  return (
    <div className="bg-[#F1F1F1] dark:bg-gray-900">
      <div className="max-w-6xl  mx-auto px-4 py-10 md:py-20">
        ...
        <div className="flex flex-col md:space-y-0 md:flex-row justify-between md:items-center mt-3"> 
          <div>
          ...
          <div className="space-x-2 flex flex-row items-center ml-auto max-sm:mr-10">
          <a
