...
function LatestCode({ repositories , latestRepo  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("section", {
        className: "bg-[#F1F1F1] mt-4 pb-10 dark:bg-gray-900 lg:pb-28 lg:-mt-36",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "lg:max-w-5xl max-w-2xl mx-auto",
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "flex flex-col mx-10 lg:flex-row justify-between items-center lg:pt-40",
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                            className: "text-7xl lg:text-8xl mt-24 mb-2 ml-5 font-bold text-gray-500 lg:pl-0 pl-5 lg:mt-2 lg:ml-8 dark:text-slate-800 text-center lg:text-left",
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("a", {
                            ...
                            className: "mb-6 lg:mb-0 px-8 py-4 mt-14 ml-2 rounded-md bg-white drop-shadow-2xl  text-xl font-semibold flex flex-row space-x-3 items-center dark:text-gray-700",
                            children: [
...
const GithubRepoCard = ({ latestRepo  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                className: "text-base font-normal my-3 text-gray-500",
...
function Hero() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "mx-auto relative text-center mb-20 mt-4 pl-11 pt-7 lg:mt-0 lg:text-left lg:pl-0 lg:pt-20 lg:pr-24 lg:pb-20 lg:mb-0",
